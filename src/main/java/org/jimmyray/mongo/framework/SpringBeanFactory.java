 ...
 * other ones are too as the spring context is stored at the class level. Use
 * with care because of that feature, if reinitialized with a different context
...
public final class SpringBeanFactory implements ApplicationContextAware {
	 ...
	 * 
	 * @param context
	 *            the new context to be used to retrieve beans for all instances
	 *            of this class.
	 */
	 ...
	 * in the /context package on the classpath. In case of use outside the web
	 * container (EJB) we need to handle manually pulling the context.
	 */
