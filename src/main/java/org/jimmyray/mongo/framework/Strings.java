...
public final class Strings {
	...
	private static final String NULL_ARGUMENT = "Argument was null.";
	...
	/**
	 * Return true if <code>outer</code> String contains <code>inner</code>.
	 * This method is case sensitive. (overloaded)
	 * 
	 * @param outer
	 * @param inner
	 * @return
	...
	/**
	 * Returns true if input string is Alpha characters (overlaoded). This
	 * version uses a boolean argument to allow white space.
	 * 
	 * @param in
	 * @param whiteSpace
	 * @return
	...
	public static boolean isAlpha(final String in, final boolean whiteSpace) {
		...
		if (whiteSpace) {
			return in
					.matches(CommonRegExPatternsEnum.ALPHA_SPACES.getPattern());
		}
	...
	/**
	 * Generates a hash from a String input. Designed to be used by hashCode()
	 * methods in objects.
	 * 
	 * @param field
	 * @return
	 */
	public static int generateIntHash(String field) {
		int result = 0;
		char[] chars = (null == field) ? "null".toCharArray() : field
				.toCharArray();
	...
	/**
	 * Parses boolean from string input, recognizes 1=true, 0=false
	 * @param in
	 * @return
	 */
	public static boolean parseBoolean(String in) {
		return ((in != null) && (in.equalsIgnoreCase("true") || in
				.equalsIgnoreCase("1")));
	}

	enum CommonRegExPatternsEnum {
		ALPHA("^[A-Za-z]+$"), //
